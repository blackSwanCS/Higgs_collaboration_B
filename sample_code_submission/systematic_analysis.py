...
def tes_fitter(model, train_set, nbin=10):
    """
    ...
    plot_shifted_score_histograms(shifted_histogram_signal, shifted_histogram_background, histogram_signal, histogram_background, nbin, range_=(0,1))
...
def jes_fitter(
    ...
    # histogram = np.histogram(score, bins=10, range=(0, 1))
